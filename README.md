...
иконки увеличены до 48 dp; если аккаунты не помещаются, виден счётчик `+N`.
Ширину виджета можно изменить на главном экране.
...
отладочный APK из текущих исходников в `dist/AIUsageMonitor-Android_v5.2-debug.apk`;
это не релизная подпись. Исходная версия 5.2 ещё не опубликована как GitHub Release.
