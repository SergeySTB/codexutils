...
[![Download for Windows](docs/design/download-windows.svg)](https://github.com/SergeySTB/codexutils/releases/download/v6.0/AIUsageMonitor-Setup_v6.0.exe)
...
[![Download for Android](docs/design/download-android.svg)](https://github.com/SergeySTB/codexutils/releases/download/v6.0/AIUsageMonitor-Android_v6.0-debug.apk)
...
Для Claude Code добавьте в `accounts` объект с `provider: "claude"`, названием и
папкой `claudeConfigDir`, например `%USERPROFILE%/.claude`. Войдите в Claude Code
с `CLAUDE_CONFIG_DIR`, указывающим на эту папку, и примените конфигурацию.
...
элемент. Папки профилей должны быть уникальными внутри каждого провайдера.
