...
отладочный APK из текущих исходников в `dist/AIUsageMonitor-Android_v5.1-debug.apk`;
это не релизная подпись. Исходная версия 5.1 ещё не опубликована как GitHub Release.
