...
внутреннее фиолетовое — за неделю. В центре значка указаны провайдер (`GPT` или
`CL`) и первая буква аккаунта.
...
![Значки GPT и Claude: метка провайдера, буква аккаунта и два кольца лимитов](docs/images/provider-icons.png)

На увеличенном примере `GPT/Л` обозначает личный Codex, `CL/Р` — рабочий Claude.
...
3. По умолчанию в конфигурации один аккаунт Codex. Нажмите его иконку (**GPT / Л**) и
