...
[![Download for Windows](docs/design/download-windows.svg)](https://github.com/SergeySTB/codexutils/releases/download/v1.3/CodexLimits-Setup_v1.3.exe)
...
# Реальное наведение на настроенные иконки у четырёх краёв, проверка карточек, снимки PNG.
